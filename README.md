...
- **🤖 Conversational AI Agent:** built with LangGraph and Gemini. You don't need to type specific commands; just talk naturally (e.g., "Please start tracking Tesla for me").
- **📰 Smart News Analysis:** Fetches real-time news via Google News RSS and uses Gemini to determine if the news is **Bullish 📈**, **Bearish 📉**, or **Neutral ⚖️**.
- **🔄 Automated Scraper:** Runs a background task every 10 minutes to check for new headlines without blocking the main web server.
- **📱 WhatsApp Integration:** Uses Twilio to receive user commands and push proactive news alerts.
- **💾 Persistent Database:** Uses SQLite to store watchlists mapped to specific WhatsApp phone numbers.
...
> 🔔 **TSLA News**
>
> 📈 BULLISH - Stock hits all-time high after earnings
>
> 🔗 [https://news.google.com/rss/articles/](https://www.google.com/search?q=https://news.google.com/rss/articles/)...

## 📂 Project Structure

```
├── main.py              # Main application logic (FastAPI + Agent + Scraper)
